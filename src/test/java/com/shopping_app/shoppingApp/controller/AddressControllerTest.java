...
public class AddressControllerTest extends AbstractControllerTest {
    ...
    public void testAddAddress_Failure_InvalidUser() {
        ...
        ResponseEntity<ApiResponse> response = httpCall("/user/100/address", HttpMethod.POST, entity, ApiResponse.class);
    ...
    public void testUpdateAddress_Failure_InvalidUser() {
        ...
        ResponseEntity<ApiResponse> response = httpCall("/user/100/address/" + addressResponseData.get("id"), HttpMethod.PUT, entity, ApiResponse.class);
    ...
    public void testUpdateAddress_Failure_InvalidAddress() {
        ...
        ResponseEntity<ApiResponse> response = httpCall("/user/" + user.get("id") + "/address/100", HttpMethod.PUT, entity, ApiResponse.class);
    ...
    public void testDeleteAddress_Failure_InvalidUser() {
        ...
        ResponseEntity<ApiResponse> response = httpCall("/user/100/address/" + addressResponseData.get("id"), HttpMethod.DELETE, entity, ApiResponse.class);
    ...
    public void testDeleteAddress_Failure_InvalidAddress() {
        ...
        ResponseEntity<ApiResponse> response = httpCall("/user/" + user.get("id") + "/address/100", HttpMethod.DELETE, entity, ApiResponse.class);
